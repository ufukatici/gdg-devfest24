...
include $_SERVER['DOCUMENT_ROOT'] . '/lib/api/numberOfRecords.php';
        ...
        <div class="d-table-cell">
            <div class="container">
                <div class="main-banner-content">
                    ...
                    <br>
                    <h1 id="sonuc" class="poppins-medium"><?php echo $_SESSION['total_users'];?> Kayıt</h1>
                    <br>
                    <br>
                    <button class="primary primary-btn" onclick="cekilisYap()">Çekilişi Başlat</button>
                </div>
            </div>
        </div>
    </div>
