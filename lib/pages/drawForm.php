...
<div class='page-title-area' style="background-image: url('../../images/main-bg4.jpg');">
    <div class="container">
        <div class="page-title-content poppins-regular">
            <h1 class="poppins-bold">Çekiliş</h1>
            <span>Çekilişe Katılmak İçin Kayıt Yapın</span>
            <ul>
                <li>
    ...
    <div class="container">
        ...
        <div class="row h-100 align-items-center contact-form">
            <div class="col-lg-12 col-md-12">
                <form action="lib/api/raffle-form.php" method="POST">
                    <div class="row poppins-regular">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="number" name="number" required disabled>
                            </div>
                        </div>

                        <div class="col-lg-12 col-md-12">
                            <button type="submit" class="primary primary-btn" disabled>Katıl</button>
                        </div>
                    </div>
                </form>
            </div>
